...
if(message.content.startsWith( prefix + 'invite')) {
        ...
        message.guild.fetchInvites().then(invs => {
            ...
            .addField('**رابط دعوة الانضمام**', `**➥** [ **https://discord.gg/${inviteCode || 'npR5zmN'}** ]`)
            .setColor('ORANGE')
            .setTimestamp()
...
client.on("guildMemberAdd", member => {
  client.channels.find('id', '529091974364397568').send(` **Welcome To Linex Server **  `)
});
/////////
client.login('NTc0Mjg5ODQ4ODUzMDY5ODU1.XM3PJQ.WlGzNsL7bCsSdmwyrntLQ2kb-4U');
